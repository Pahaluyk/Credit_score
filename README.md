...
# 🚀 Полная инструкция по запуску ZenML + MLflow проекта
...
# Шаг 4: Установка ZenML с поддержкой сервера
pip install "zenml[server]"

# Шаг 5: Установка интеграции MLflow
zenml integration install mlflow -y

# Шаг 6: Настройка ZenML (инициализация стора, стека, эксперимент-трекера и т.д.)
python setup_zenml.py

# Шаг 7: Запуск пайплайна
python run_pipeline.py

# Шаг 8: Вход в ZenML Dashboard (локальный режим)
